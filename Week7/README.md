...
docsense_rag/
├── src/
│   ├── app.py            # Streamlit UI — chat interface, upload, dark theme
│   ├── vectorstore.py    # PDF extraction, chunking, Cohere embeddings, Pinecone
│   └── chatbot.py        # Grounded generation via Cohere Chat API + citations
├── requirements.txt
├── LICENSE
└── README.md
```
