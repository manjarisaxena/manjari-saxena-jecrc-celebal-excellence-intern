...
vector storage + retrieval for the DocSense AI RAG system.
"""
...
class DocSenseVectorStore:
    ...
    def __init__(self, cohere_api_key: str, pinecone_api_key: str, index_name: str = "docsense-rag"):
